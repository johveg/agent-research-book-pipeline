...
- The captured Hermes documentation includes concrete guides, which makes official docs and repository material safer citation authority than social summaries. [4] [3] (status `supported`, moderate evidence)
...
- Bullet 2 maps to supported claim: “The captured Hermes documentation includes concrete guides, which makes official docs and repository material safer citation authority than social summaries.”; source tokens: [4] [3].
...
- 2026-06-30T08:49:06Z: conservative evidence-status regeneration for run context.

## Editorial policy

Last generated: 2026-06-30T08:49:06Z. This chapter is not synthesized directly from raw LinkedIn/social/web captures; it only uses claim records from `docs/research/claims.md`, and social material remains discovery signal only.
