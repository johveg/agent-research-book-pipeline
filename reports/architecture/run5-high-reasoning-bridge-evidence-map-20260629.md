...
- `/tmp/pytest-of-root/pytest-627/test_source_cards_high_reasoni0/test-source-cards-hr-source-card-drafts-high-reasoning.md`: generated Markdown source-card report.
- `/tmp/pytest-of-root/pytest-627/test_source_cards_high_reasoni0/test-source-cards-hr-source-card-drafts-high-reasoning.json`: generated JSON source-card report.
- `reports/architecture/run5-high-reasoning-bridge-evidence-map-20260629.md`: Run 2 evidence map.
