# Run 1 LLM reasoning dry-run evidence map — 20260629
...
- `/tmp/pytest-of-root/pytest-627/test_llm_reasoning_dry_run_doe0/test-llm-dry-run-safety-llm-reasoning-dry-run.md`: generated advisory Markdown report.
- `/tmp/pytest-of-root/pytest-627/test_llm_reasoning_dry_run_doe0/test-llm-dry-run-safety-llm-reasoning-dry-run.json`: generated advisory JSON report.
- `reports/architecture/run1-llm-reasoning-dry-run-evidence-map-20260629.md`: implementation/evidence map for Run 1 evaluation.
