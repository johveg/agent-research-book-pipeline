# Run 2 source-card drafts evidence map — 20260629
...
- `/tmp/pytest-of-root/pytest-627/test_source_cards_write_source0/test-source-cards-persist-9300cb9d85c444329268bd34610a8e04-source-card-drafts.md`: generated Markdown source-card report.
- `/tmp/pytest-of-root/pytest-627/test_source_cards_write_source0/test-source-cards-persist-9300cb9d85c444329268bd34610a8e04-source-card-drafts.json`: generated JSON source-card report.
- `reports/architecture/run3-source-card-persistence-evidence-map-20260629.md`: Run 2 evidence map.
