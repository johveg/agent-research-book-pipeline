...
- ok: `False`
- expected_run_id: `production-daily-20260630`
- schedule due: `True`
- crontab production command found: `False`
- production report JSON: `/home/hermoine/agent-research-book-pipeline/reports/editorial/production-daily-20260630-production-execute-once.json` exists `True`
- production report MD: `/home/hermoine/agent-research-book-pipeline/reports/editorial/production-daily-20260630-production-execute-once.md` exists `True`
- telegram status path: `/home/hermoine/agent-research-book-pipeline/reports/telegram/production-daily-latest.md` exists `True`
- log path: `/home/hermoine/agent-research-book-pipeline/logs/runs/production-daily-20260630.log` exists `True`
- disposition: `production_daily_failed_closed`
