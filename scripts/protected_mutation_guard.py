...
PROFILES: dict[str, dict[str, Any]] = {
    ...
    "academic_introduction_report_only": {
        "allowed": [
            ...
            "tests/test_protected_mutation_guard.py",
            "reports/editorial/run50-*.json",
            "reports/editorial/run50-*.md",
            "reports/architecture/run50-*.md",
    ...
    "closed_loop_manuscript_production": {
        "allowed": [
            ...
            "reports/editorial/run58-*.json",
            "reports/editorial/run58-*.md",
            "reports/manuscript/run58-*.json",
            "reports/manuscript/run58-*.md",
            "reports/architecture/run58-*.md",
        ...
        "future_disabled": False,
        "enforce_required_gates": True,
        "required_gates": ["manuscript_quality_passed", "evidence_safety_passed", "chapter_canary_published", "publication_candidate"],
    },
    "run59_agent_loop_publication_proof": {
        "allowed": [
            ...
            "tests/test_protected_mutation_guard.py",
            "tests/test_verify_book_workspace.py",
            "docs/book/01-the-agent-loop.md",
            "reports/editorial/run59-*.json",
            "reports/editorial/run59-*.md",
            "reports/telegram/run59-*.md",
            "reports/architecture/run59-*.md",
            "reports/manuscript/run59-*.json",
            "reports/manuscript/run59-*.md",
            "reports/ops/outbox/*",
        ],
        "allow_db": {},
        "allow_protected_path_delta": ["docs/book"],
        ...
        "future_disabled": False,
        "enforce_required_gates": True,
        "required_gates": ["local_after_ok", "public_page_booklike", "public_proof_passed", "publication_candidate"],
    },
    "closed_loop_manuscript_public_proof": {
        "allowed": [
            "scripts/daily_book_worker.py",
            "scripts/public_chapter_proof.py",
            "scripts/protected_mutation_guard.py",
            ...
            "tests/test_protected_mutation_guard.py",
            "reports/editorial/run60-*.json",
            "reports/editorial/run60-*.md",
            "reports/telegram/run60-*.md",
            "reports/architecture/run60-*.md",
        ],
        "allow_db": {},
        "allow_sqlite_physical_hash_drift_without_logical_delta": True,
        ...
        "future_disabled": False,
        "enforce_required_gates": True,
        "required_gates": ["all_chapter_public_proof_gate_wired", "autonomous_closed_loop_iteration_coverage"],
    },
    ...
    "ops_channel_alias_resolution": {
        "allowed": [
            ...
            "tests/test_protected_mutation_guard.py",
            "reports/editorial/run52-*.json",
            "reports/editorial/run52-*.md",
            "reports/architecture/run52-*.md",
            "reports/telegram/run52-*.md",
            "reports/telegram/production-monitor-latest.md",
        ],
        "allow_db": {},
        "allow_sqlite_physical_hash_drift_without_logical_delta": True,
    ...
    "autonomy_acceleration_control_plane": {
        "allowed": [
            ...
            "tests/test_protected_mutation_guard.py",
            "reports/editorial/run54-*.json",
            "reports/editorial/run54-*.md",
            "reports/architecture/run54-*.md",
            "reports/telegram/run54-*.md",
            "reports/ops/outbox/**",
            "logs/runs/ops-delivery-controller-*.log",
        ],
        "allow_db": {},
        "allow_sqlite_physical_hash_drift_without_logical_delta": True,
        "future_disabled": False,
    ...
    "production_daily_publish": {
        "allowed": [
            ...
            "scripts/closed_loop_publication_orchestrator.py",
            "scripts/closed_loop_book_publisher.py",
            "scripts/book_event_dispatcher.py",
            "scripts/book_publication_joiner.py",
            "scripts/chapter_creation_worker.py",
            "scripts/chapter_router.py",
            "scripts/chapter_update_worker.py",
            "scripts/protected_mutation_guard.py",
            "tests/test_closed_loop_production_scheduler.py",
            "tests/test_closed_loop_runtime_config.py",
            "tests/test_event_driven_book_production.py",
            "tests/test_protected_mutation_guard.py",
            "raw/**",
            "data/source_registry.json",
            ".var/book.sqlite",
...
def _scan_changed_report_files(root: Path, changed_paths: list[str]) -> tuple[bool, dict[str, bool], dict[str, Any]]:
    ...
    safety_keys = [
        ...
        "local_after_ok",
        "public_page_booklike",
        "public_proof_passed",
        "all_chapter_public_proof_gate_wired",
        "autonomous_closed_loop_iteration_coverage",
