# Run 2 source-card drafts evidence map — 20260613
...
- `/tmp/pytest-of-root/pytest-124/test_source_cards_write_source0/test-source-cards-persist-9cb92ddfd6724a96b9970642d43ea4ac-source-card-drafts.md`: generated Markdown source-card report.
- `/tmp/pytest-of-root/pytest-124/test_source_cards_write_source0/test-source-cards-persist-9cb92ddfd6724a96b9970642d43ea4ac-source-card-drafts.json`: generated JSON source-card report.
- `reports/architecture/run3-source-card-persistence-evidence-map-20260613.md`: Run 2 evidence map.
