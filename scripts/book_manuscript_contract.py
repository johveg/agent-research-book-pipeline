...
def build_queue(contract: dict) -> dict:
    ...
    for cid in ["introduction", "methodology", "hermes", "openclaw", "loop_engineering", "context_memory", "operating_loops"]:
        ...
        queue.append({
            ...
            "required_gates": ["input_packet_valid", "draft_created", "manuscript_quality_passed", "evidence_safety_passed", "publisher_scope_valid", "mkdocs_strict_passed", "mutation_guard_passed"],
