...
def capture_one(item: dict[str, str], run_id: str, pixelshot: str) -> dict[str, Any]:
    ...
    meta = {
        ...
        "provenance": {
            "original_url": url,
            "originating_query": item.get("query") or "",
            "source_title": item.get("title") or "",
            "publisher": parsed.netloc,
            "captured_at": now,
            "run_id": run_id,
            "capture_tool": "pixelshot",
            "capture_mode": "pixel_native_screenshot_tiles",
        },
        "book_usage": {
            "eligible": False,
            "usage": "supplemental_visual_evidence_only",
            "may_be_used_for": ["layout_evidence", "table_or_chart_context", "diagram_context", "visual_corroboration"],
            ...
            "public_book_rule": "Do not embed or cite visual tiles directly in docs/book until license/source-support review and public proof pass.",
        },
        "license_review": {
            "required": True,
            "status": "not_reviewed",
            "reason": "Screenshots may contain third-party copyrighted material; publication requires explicit review.",
        },
