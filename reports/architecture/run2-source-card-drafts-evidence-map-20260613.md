...
- `/tmp/pytest-of-root/pytest-28/test_source_cards_default_does0/test-source-cards-safety-source-card-drafts.md`: generated Markdown source-card report.
- `/tmp/pytest-of-root/pytest-28/test_source_cards_default_does0/test-source-cards-safety-source-card-drafts.json`: generated JSON source-card report.
- `reports/architecture/run2-source-card-drafts-evidence-map-20260613.md`: Run 2 evidence map.
