# Run 2 source-card drafts evidence map — 20260626
...
- `/tmp/pytest-of-root/pytest-609/test_source_cards_write_source0/test-source-cards-persist-c28d732244ad4ca2b502d07f82c6e4d0-source-card-drafts.md`: generated Markdown source-card report.
- `/tmp/pytest-of-root/pytest-609/test_source_cards_write_source0/test-source-cards-persist-c28d732244ad4ca2b502d07f82c6e4d0-source-card-drafts.json`: generated JSON source-card report.
- `reports/architecture/run3-source-card-persistence-evidence-map-20260626.md`: Run 2 evidence map.
